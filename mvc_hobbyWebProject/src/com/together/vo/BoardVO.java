...
public class BoardVO {
	...
	public BoardVO(int boardID, String userID, String boardTitle, String boardContent, String boardCategory,
	...
	public String toString() {
		return "BoardVO [boardID=" + boardID + ", boardTitle=" + boardTitle + ", userID=" + userID + ", boardDate="
				...
				+ ", boardCategory=" + boardCategory + ", viewCount=" + viewCount + ", heartCount=" + heartCount
				+ ", filename=" + filename + ", fileRealname=" + fileRealname + ", fileDownCount=" + fileDownCount
				+ "]";
	}
