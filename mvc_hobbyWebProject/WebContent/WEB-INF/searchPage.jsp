...
<%@page import="com.together.vo.BoardVO"%>
					...
					<c:forEach var="vo" items="${boardlist}">
				        <tr class="board-row">
				        	...
				        	<c:if test="${empty vo.filename}">
				        		<td><a id="click-view" href="view?boardID=${vo.boardID}">${vo.boardTitle}</a></td>
				        	</c:if>
				        	<c:if test="${not empty vo.filename}">
				        		<td><a id="click-view" href="view?boardID=${vo.boardID}">${vo.boardTitle}&nbsp;&nbsp;<i class="fa-solid fa-paperclip"></i></a></td>
				        	</c:if>
				            <td>${vo.userID}</td>
				            <td>${vo.heartCount}</td>
				            <td>empty</td>
